...
const timelineCardsRepl = 'className:`cursor-pointer flex items-center justify-between p-4 rounded-2xl border transition-all duration-300 ${h?"bg-amber-50/10 hover:border-amber-700":r===1?"bg-white shadow-md ring-2 ring-amber-50/50":"bg-white opacity-70 hover:opacity-100 shadow-sm glass"}`,style:{borderColor:h?"#a78235":r===1?"#dfba6b":"#e2e8f0",borderWidth:"1px"}';
...
const timelineNodesRepl = 'className:`absolute -left-[27px] top-6 -translate-y-1/2 w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold transition-all duration-300 z-10 font-display ${h?"text-white shadow-md":r===1?"text-slate-900 ring-4 ring-amber-50/50":"text-slate-400 border border-[#e2e8f0]"}`,style:{backgroundColor:h?"#a78235":r===1?"#dfba6b":"#ffffff",borderColor:h?"#ffffff":r===1?"#ffffff":"#e2e8f0",borderWidth:"2px"}';
