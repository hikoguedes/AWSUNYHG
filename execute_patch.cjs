...
const hotelWrapperRepl = 'T.map(s=>e.jsxs("div",{className:"bg-white border border-[#e2e8f0] hover:border-amber-400 hover:shadow-lg rounded-3xl overflow-hidden flex flex-col justify-between transition-all glass",style:{position:"relative",borderColor:(h==null?void 0:h.id)===s.id?"#0d7e68":"",borderWidth:(h==null?void 0:h.id)===s.id?"2px":""},children:[(h==null?void 0:h.id)===s.id&&e.jsx("span",{className:"absolute top-3 left-3 text-[9px] font-black px-2.5 py-1 rounded-full shadow font-display z-20 border",style:{backgroundColor:"#ffffff",borderColor:"#0d7e68",borderWidth:"1.5px",color:"#0d7e68",boxShadow:"0 2px 4px rgba(13,126,104,0.1)"},children:"SELECIONADO"}),e.jsxs("div"';
...
const carWrapperRepl = 'le.map(s=>e.jsxs("div",{className:"bg-white border border-[#e2e8f0] hover:border-sky-400 hover:shadow-lg rounded-3xl p-4 flex flex-col justify-between h-[375px] transition-all glass",style:{position:"relative",borderColor:(x==null?void 0:x.id)===s.id?"#0d7e68":"",borderWidth:(x==null?void 0:x.id)===s.id?"2px":""},children:[(x==null?void 0:x.id)===s.id&&e.jsx("span",{className:"absolute top-6 left-6 text-[9px] font-black px-2.5 py-1 rounded-full shadow font-display z-20 border",style:{backgroundColor:"#ffffff",borderColor:"#0d7e68",borderWidth:"1.5px",color:"#0d7e68",boxShadow:"0 2px 4px rgba(13,126,104,0.1)"},children:"SELECIONADO"}),e.jsxs("div"';
...
const flightWrapperRepl = 'te.map(s=>e.jsxs("div",{className:"bg-white border border-[#e2e8f0] hover:border-indigo-400 hover:shadow-lg rounded-3xl overflow-hidden flex flex-col md:flex-row transition-all glass",style:{position:"relative",borderColor:(d==null?void 0:d.id)===s.id?"#0d7e68":"",borderWidth:(d==null?void 0:d.id)===s.id?"2px":""},children:[(d==null?void 0:d.id)===s.id&&e.jsx("span",{className:"absolute top-3 right-3 text-[9px] font-black px-2.5 py-1 rounded-full shadow font-display z-20 border",style:{backgroundColor:"#ffffff",borderColor:"#0d7e68",borderWidth:"1.5px",color:"#0d7e68",boxShadow:"0 2px 4px rgba(13,126,104,0.1)"},children:"SELECIONADO"}),s.image&&e.jsx("div",{className:"w-full md:w-36 h-28 md:h-auto bg-slate-100 relative shrink-0",children:e.jsx("img",{src:s.image,alt:s.airline,className:"w-full h-full object-cover"})})';
...
const busWrapperRepl = 'L.map(s=>e.jsxs("div",{className:"bg-white border border-[#e2e8f0] hover:border-pink-400 hover:shadow-lg rounded-3xl overflow-hidden flex flex-col md:flex-row transition-all glass",style:{position:"relative",borderColor:(m==null?void 0:m.id)===s.id?"#0d7e68":"",borderWidth:(m==null?void 0:m.id)===s.id?"2px":""},children:[(m==null?void 0:m.id)===s.id&&e.jsx("span",{className:"absolute top-3 right-3 text-[9px] font-black px-2.5 py-1 rounded-full shadow font-display z-20 border",style:{backgroundColor:"#ffffff",borderColor:"#0d7e68",borderWidth:"1.5px",color:"#0d7e68",boxShadow:"0 2px 4px rgba(13,126,104,0.1)"},children:"SELECIONADO"}),s.image&&e.jsx("div",{className:"w-full md:w-36 h-28 md:h-auto bg-slate-100 relative shrink-0",children:e.jsx("img",{src:s.image,alt:s.provider,className:"w-full h-full object-cover"})})';
...
const insWrapperRepl = 'z.map(s=>e.jsxs("div",{className:"bg-white border border-[#e2e8f0] hover:border-rose-400 hover:shadow-lg rounded-3xl p-5 flex flex-col justify-between h-[320px] transition-all glass",style:{position:"relative",borderColor:(p==null?void 0:p.id)===s.id?"#0d7e68":"",borderWidth:(p==null?void 0:p.id)===s.id?"2px":""},children:[(p==null?void 0:p.id)===s.id&&e.jsx("span",{className:"absolute top-5 right-5 text-[9px] font-black px-2.5 py-1 rounded-full shadow font-display z-20 border",style:{backgroundColor:"#ffffff",borderColor:"#0d7e68",borderWidth:"1.5px",color:"#0d7e68",boxShadow:"0 2px 4px rgba(13,126,104,0.1)"},children:"SELECIONADO"}),e.jsxs("div",{className:"space-y-2",children:[e.jsx("div",{className:"w-10 h-10 bg-rose-50 rounded-xl flex items-center justify-center text-[#f43f5e] border border-rose-100",children:e.jsx(we,{className:"w-5 h-5"})}),e.jsx("h3",{className:"font-bold text-slate-855 text-xs leading-tight font-display",children:s.planName||s.name})';
...
const mainWrapperRepl = 'e.jsx("main",{className:"flex-1 min-w-0 h-screen overflow-hidden flex flex-col bg-white p-4 lg:p-6 space-y-4",style:{backgroundColor:"#ffffff"},children:e.jsxs("div",{className:"w-full flex-1 min-h-0 flex flex-col space-y-4 overflow-hidden",children:[e.jsx("style",{children:`body,#root,main{background-color:#ffffff!important;background-image:none!important}.glass,.bg-white,section,aside,header{background-color:#ffffff!important;background-image:none!important;border-color:#cbd5e1!important;box-shadow:0 4px 6px -1px rgba(0,0,0,0.03),0 2px 4px -2px rgba(0,0,0,0.03)!important}h1,h2,h3,h4,h5,h6,p,span,label,input,select,button{color:#0f172a!important}button.btn-gold,button[type="submit"]{background:linear-gradient(135deg,#a78235 0%,#dfba6b 100%)!important;color:#0f172a!important;font-weight:900!important;border:1px solid rgba(167,130,53,0.2)!important;box-shadow:0 4px 6px -1px rgba(167,130,53,0.1),0 2px 4px -2px rgba(167,130,53,0.1)!important}button.btn-gold:hover,button[type="submit"]:hover{filter:brightness(1.05)!important}input[type="text"],input[type="date"],select,.glass-input{border:1px solid #cbd5e1!important;background-color:#ffffff!important;color:#0f172a!important;border-radius:0.75rem!important}svg{color:#1e293b!important}`}),';
...
if (content.includes(buscarBtnTarget) && content.includes(bonusBoxTarget) && content.includes(verticalLineTarget) && content.includes(categoryBadgeTarget)) {
  ...
  for (const s of stepsData) {
    ...
    const cardRepl = `className:\`cursor-pointer flex items-center justify-between p-4 rounded-2xl border transition-all duration-300 \\\${${s.variable}?"bg-amber-50/10 hover:border-amber-700":r===${s.step}?"bg-white shadow-md ring-2 ring-amber-50/50":"bg-white opacity-70 hover:opacity-100 shadow-sm glass"}\`,style:{borderColor:${s.variable}?"#a78235":r===${s.step}?"#dfba6b":"#cbd5e1",borderWidth:"1px"}`;
    ...
    const nodeRepl = `className:\`absolute -left-[27px] top-6 -translate-y-1/2 w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold transition-all duration-300 z-10 font-display \\\${${s.variable}?"text-white shadow-md":r===${s.step}?"text-slate-900 ring-4 ring-amber-50/50":"text-slate-400 border border-[#cbd5e1]"}\`,style:{backgroundColor:${s.variable}?"#a78235":r===${s.step}?"#dfba6b":"#ffffff",borderColor:${s.variable}?"#ffffff":r===${s.step}?"#ffffff":"#cbd5e1",borderWidth:"2px"}`;
    ...
    const iconRepl = `className:\`w-8 h-8 rounded-xl flex items-center justify-center shrink-0 transition \\\${${s.variable}?"text-[#a78235]":r===${s.step}?"text-slate-900":"text-slate-400"}\`,style:{backgroundColor:${s.variable}?"rgba(167, 130, 53, 0.1)":r===${s.step}?"#dfba6b":"#f1f5f9"}`;
