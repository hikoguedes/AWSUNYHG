...
const carWrapperRepl = 'le.map(s=>e.jsxs("div",{className:"bg-white border border-[#e2e8f0] hover:border-sky-400 hover:shadow-lg rounded-3xl p-4 flex flex-col justify-between h-[375px] transition-all glass "+((x==null?void 0:x.id)===s.id?"selected-car":""),style:{position:"relative",borderColor:(x==null?void 0:x.id)===s.id?"#0ea5e9":"",borderWidth:(x==null?void 0:x.id)===s.id?"2px":""},children:[(x==null?void 0:x.id)===s.id&&e.jsx("span",{className:"absolute top-6 left-6 text-[9px] font-black px-2.5 py-1 rounded-full shadow font-display z-20 border",style:{backgroundColor:"#0ea5e9",borderColor:"#0ea5e9",borderWidth:"1.5px",color:"#ffffff"},children:"SELECIONADO"}),e.jsxs("div"';
...
const flightWrapperRepl = 'te.map(s=>e.jsxs("div",{className:"bg-white border border-[#e2e8f0] hover:border-indigo-400 hover:shadow-lg rounded-3xl overflow-hidden flex flex-col md:flex-row transition-all glass "+((d==null?void 0:d.id)===s.id?"selected-flight":""),style:{position:"relative",borderColor:(d==null?void 0:d.id)===s.id?"#6366f1":"",borderWidth:(d==null?void 0:d.id)===s.id?"2px":""},children:[(d==null?void 0:d.id)===s.id&&e.jsx("span",{className:"absolute top-3 right-3 text-[9px] font-black px-2.5 py-1 rounded-full shadow font-display z-20 border",style:{backgroundColor:"#6366f1",borderColor:"#6366f1",borderWidth:"1.5px",color:"#ffffff"},children:"SELECIONADO"}),s.image&&e.jsx("div",{className:"w-full md:w-36 h-28 md:h-auto bg-slate-100 relative shrink-0",children:e.jsx("img",{src:s.image,alt:s.airline,className:"w-full h-full object-cover"})})';
...
const busWrapperRepl = 'L.map(s=>e.jsxs("div",{className:"bg-white border border-[#e2e8f0] hover:border-pink-400 hover:shadow-lg rounded-3xl overflow-hidden flex flex-col md:flex-row transition-all glass "+((m==null?void 0:m.id)===s.id?"selected-bus":""),style:{position:"relative",borderColor:(m==null?void 0:m.id)===s.id?"#ec4899":"",borderWidth:(m==null?void 0:m.id)===s.id?"2px":""},children:[(m==null?void 0:m.id)===s.id&&e.jsx("span",{className:"absolute top-3 right-3 text-[9px] font-black px-2.5 py-1 rounded-full shadow font-display z-20 border",style:{backgroundColor:"#ec4899",borderColor:"#ec4899",borderWidth:"1.5px",color:"#ffffff"},children:"SELECIONADO"}),s.image&&e.jsx("div",{className:"w-full md:w-36 h-28 md:h-auto bg-slate-100 relative shrink-0",children:e.jsx("img",{src:s.image,alt:s.provider,className:"w-full h-full object-cover"})})';
