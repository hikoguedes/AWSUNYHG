...
if (content.includes(buscarBtnTarget) && content.includes(bonusBoxTarget) && content.includes(verticalLineTarget) && content.includes(categoryBadgeTarget)) {
  ...
  const passengerRepl = 'e.jsxs("div",{className:"space-y-1.5 relative",children:[e.jsx("label",{className:"text-[10px] text-slate-400 font-bold uppercase tracking-wider",children:"Passageiros & Quartos"}),e.jsxs("div",{id:"unyco-passenger-container",className:"relative cursor-pointer",onClick:()=>{window.unycoDropdownState=window.unycoDropdownState||{adults:2,children:0,rooms:1,isOpen:false};window.unycoDropdownState.isOpen=!window.unycoDropdownState.isOpen;window.unycoTriggerRender=()=>{k((w||"2 Ad, 1 Qto").trim()+(window.unycoDropdownState.isOpen?" ":""));};window.unycoTriggerRender();if(window.unycoDropdownState.isOpen&&!window.unycoDropdownListener){window.unycoDropdownListener=(e)=>{const el=document.getElementById("unyco-passenger-container");if(el&&!el.contains(e.target)){window.unycoDropdownState.isOpen=false;if(window.unycoTriggerRender)window.unycoTriggerRender();document.removeEventListener("click",window.unycoDropdownListener);window.unycoDropdownListener=null;}};setTimeout(()=>{document.addEventListener("click",window.unycoDropdownListener);},50);}},children:[e.jsx(ne,{className:"w-4 h-4 text-slate-400 absolute left-3.5 top-1/2 -translate-y-1/2"}),e.jsx("input",{type:"text",value:w,readOnly:true,placeholder:"2 Ad, 1 Qto",className:"w-full glass-input rounded-xl py-2.5 pl-10 pr-4 text-xs font-bold text-slate-700 outline-none transition cursor-pointer"}),(()=> { const r=window.unycoDropdownState=window.unycoDropdownState||{adults:2,children:0,rooms:1,isOpen:false};if(w){const o=w.match(/(\\d+)\\s*Ad/i),i=w.match(/(\\d+)\\s*Crian/i),n=w.match(/(\\d+)\\s*Qto/i);if(o)r.adults=parseInt(o[1],10);if(i)r.children=parseInt(i[1],10);if(n)r.rooms=parseInt(n[1],10);}const a=(o,i,n)=>{r.adults=Math.max(1,o);r.children=Math.max(0,i);r.rooms=Math.max(1,n);let c=r.adults+" Ad";if(r.children>0)c+=", "+r.children+" Crian";c+=", "+r.rooms+" Qto";k(c);};return r.isOpen?e.jsxs("div",{onClick:(s)=>s.stopPropagation(),className:"absolute right-0 top-full mt-2 w-72 bg-white border border-slate-200 rounded-2xl p-4 shadow-xl z-50 space-y-4",style:{boxShadow:"0 10px 25px -5px rgba(0,0,0,0.1),0 8px 10px -6px rgba(0,0,0,0.1)"},children:[e.jsxs("div",{className:"flex items-center justify-between py-2 border-b border-slate-50",children:[e.jsxs("div",{className:"flex items-center",children:[e.jsx("div",{className:"w-9 h-9 rounded-xl bg-blue-50 flex items-center justify-center shrink-0",children:e.jsx("svg",{className:"w-4 h-4 text-blue-500",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor",strokeWidth:2.5,children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"})})}),e.jsxs("div",{className:"ml-3 text-left",children:[e.jsx("span",{className:"text-xs font-extrabold text-slate-800 block",children:"Adultos"}),e.jsx("span",{className:"text-[9px] text-slate-400 block",children:"a partir de 18 anos"})]})]}),e.jsxs("div",{className:"flex items-center gap-3.5",children:[e.jsx("button",{type:"button",disabled:r.adults<=1,onClick:()=>a(r.adults-1,r.children,r.rooms),className:"w-7 h-7 rounded-full border border-slate-200 flex items-center justify-center text-slate-500 hover:bg-slate-50 transition font-bold disabled:opacity-30 disabled:pointer-events-none",children:"-"}),e.jsx("span",{className:"w-5 text-center text-xs font-black text-slate-800",children:r.adults}),e.jsx("button",{type:"button",onClick:()=>a(r.adults+1,r.children,r.rooms),className:"w-7 h-7 rounded-full border border-slate-200 flex items-center justify-center text-slate-500 hover:bg-slate-50 transition font-bold",children:"+"})]})]}),e.jsxs("div",{className:"flex items-center justify-between py-2 border-b border-slate-50",children:[e.jsxs("div",{className:"flex items-center",children:[e.jsx("div",{className:"w-9 h-9 rounded-xl bg-blue-50 flex items-center justify-center shrink-0",children:e.jsx("svg",{className:"w-4 h-4 text-blue-500",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor",strokeWidth:2.5,children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"})})}),e.jsxs("div",{className:"ml-3 text-left",children:[e.jsx("span",{className:"text-xs font-extrabold text-slate-800 block",children:"Crianças"}),e.jsx("span",{className:"text-[9px] text-slate-400 block",children:"de 0 a 17 anos"})]})]}),e.jsxs("div",{className:"flex items-center gap-3.5",children:[e.jsx("button",{type:"button",disabled:r.children<=0,onClick:()=>a(r.adults,r.children-1,r.rooms),className:"w-7 h-7 rounded-full border border-slate-200 flex items-center justify-center text-slate-500 hover:bg-slate-50 transition font-bold disabled:opacity-30 disabled:pointer-events-none",children:"-"}),e.jsx("span",{className:"w-5 text-center text-xs font-black text-slate-800",children:r.children}),e.jsx("button",{type:"button",onClick:()=>a(r.adults,r.children+1,r.rooms),className:"w-7 h-7 rounded-full border border-slate-200 flex items-center justify-center text-slate-500 hover:bg-slate-50 transition font-bold",children:"+"})]})]}),e.jsxs("div",{className:"flex items-center justify-between py-2",children:[e.jsxs("div",{className:"flex items-center",children:[e.jsx("div",{className:"w-9 h-9 rounded-xl bg-blue-50 flex items-center justify-center shrink-0",children:e.jsx("svg",{className:"w-4 h-4 text-blue-500",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor",strokeWidth:2.5,children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M3 10V19c0 .55.45 1 1 1h16c.55 0 1-.45 1-1V10c0-1.1-.9-2-2-2h-8V5c0-.55-.45-1-1-1H5c-1.1 0-2 .9-2 2v4zm15-1a1 1 0 110 2 1 1 0 010-2zm-6-3h6v2h-6V6zm-8 4h8v3H4v-3z"})})}),e.jsxs("div",{className:"ml-3 text-left",children:[e.jsx("span",{className:"text-xs font-extrabold text-slate-800 block",children:"Quartos"})]})]}),e.jsxs("div",{className:"flex items-center gap-3.5",children:[e.jsx("button",{type:"button",disabled:r.rooms<=1,onClick:()=>a(r.adults,r.children,r.rooms-1),className:"w-7 h-7 rounded-full border border-slate-200 flex items-center justify-center text-slate-500 hover:bg-slate-50 transition font-bold disabled:opacity-30 disabled:pointer-events-none",children:"-"}),e.jsx("span",{className:"w-5 text-center text-xs font-black text-slate-800",children:r.rooms}),e.jsx("button",{type:"button",onClick:()=>a(r.adults,r.children,r.rooms+1),className:"w-7 h-7 rounded-full border border-slate-200 flex items-center justify-center text-slate-500 hover:bg-slate-50 transition font-bold",children:"+"})]})]}),e.jsx("button",{type:"button",onClick:()=>{r.isOpen=false;if(window.unycoTriggerRender)window.unycoTriggerRender();if(window.unycoDropdownListener){document.removeEventListener("click",window.unycoDropdownListener);window.unycoDropdownListener=null;}},className:"w-full py-2.5 bg-slate-900 text-white text-xs font-bold rounded-xl mt-2 hover:bg-slate-800 transition font-display",children:"CONFIRMAR"})]}):null;})()]})]})';
